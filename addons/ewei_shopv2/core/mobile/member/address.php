...
class Address_EweiShopV2Page extends MobileLoginPage 
{
	...
	public function update()
	{
		...
		global $_GPC;	
		$id = intval($_GPC['id']);
		pdo_update('ewei_shop_member_address',array('isdefault'=>0),array('openid'=>$_W['openid']));
		pdo_update('ewei_shop_member_address',array('isdefault'=>1),array('openid'=>$_W['openid'],'id'=>$id));		
		exit();
	}
