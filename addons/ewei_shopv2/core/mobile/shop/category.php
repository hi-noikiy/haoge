...
class Category_EweiShopV2Page extends MobilePage 
{
	public function main() 
	{
		...
		$category = $this->getCategory($category_set['level'], $merchid)['parent'][0];
		

		foreach ($category as $key => $value) {
				if($value['id']=='1179'  || $value['id']=='1180' || $value['id']=='1181'){
					unset($category[$key]);
				}
		}
	...
	public function get_list() 
	{
		global $_W;
		global $_GPC;
		$args = array('page' => $_GPC['page'], 'pagesize' =>4, 'cate' => $_GPC['cateid'], 'order' => 'displayorder desc,createtime desc', 'by' => '');
