...
class List_EweiShopV2Page extends WebPage 
{
	public function main() 
	{
		...
		foreach ($list as &$row ) 
		{
			...
			//$row['M1'] = m('member')->GetPersonAchievement(1,$row['openid']);//上月个人业绩
			//$row['M2'] = m('member')->GetPersonAchievement(2,$row['openid']);//本月个人业绩			

			//$row['M3'] = m('member')->GetTeamAchievement(1,$row['openid']);//上月团队业绩
			//$row['M4'] = m('member')->GetTeamAchievement(2,$row['openid']);//本月团队业绩				
		}
		unset($row);
		if ($_GPC['export'] == '1') 
		{
	...
	public function detail() 
	{
		...
		$TeamM1 = m('member')->GetTeamAchievement(1,$member['openid']);//上月团队业绩
		$TeamM2 = m('member')->GetTeamAchievement(2,$member['openid']);//本月团队业绩
		$PerM1 = m('member')->GetPersonAchievement(1,$member['openid']);//上月个人业绩
		$PerM2 = m('member')->GetPersonAchievement(2,$member['openid']);//本月个人业绩		
