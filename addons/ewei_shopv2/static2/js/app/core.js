      ...
      core.loading =  function() {
          var u = navigator.userAgent, app = navigator.appVersion;
           if ($('#core_loading').length <= 0) {
                $('body').append('<div id="core_loading" style="top:50%;left:50%;margin-left:-35px;margin-top:-30px;position:absolute;width:80px;z-index:999999"><img src="/addons/ewei_shopv2/static2/images/loading.svg" width="80" /></div>')
            }
            else{
                $('#core_loading').show();
            }
